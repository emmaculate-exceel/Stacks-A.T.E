...
type TabType = 'overview' | 'resources' | 'stats';

const RouteDetailPanel: React.FC<RouteDetailPanelProps> = ({ route, onClose, onDelete, onToggleStatus }) => {
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
              ...
              <div className="bg-gray-800/70 rounded-lg p-4">
                ...
                <p className="text-xl font-bold text-white">{route.profit} <span className="text-xs text-gray-400">FLOW</span></p>
              </div>
        ...
        {activeTab === 'stats' && (
          ...
          >
            <div className="bg-gray-800/70 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-white">{route.merchants || 0}</p>
            ...
            <div className="bg-gray-800/70 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-white">{route.completedTrades || 0}</p>
              ...
              <div className="relative w-full h-4 bg-gray-700 rounded-full overflow-hidden mb-2">
                <div 
                  className={`h-full rounded-full ${
                    (route.successRate || 0) > 80 ? 'bg-green-500' 
                    : (route.successRate || 0) > 50 ? 'bg-yellow-500' 
                    : 'bg-red-500'
                  }`}
                  style={{ width: `${route.successRate || 0}%` }}
                ></div>
              </div>
              <div className="flex justify-between">
                <p className="text-sm font-bold text-white">{route.successRate || 0}%</p>
